...
public class Bee1079 {
    public static void main (String[] args) {
        ...
        consists of three floating-point numbers, each one with one digit after the decimal point.
        ...
        test case with three float-point numbers, each one with one digit after the decimal point.
