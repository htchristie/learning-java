...
public class Bee1115 {
    public static void main (String[] args) {
        ...
        when at least negatives of sumAndAverage coordinates is NULL (in this situation without writing any message).

        Input
        The input contains several tests cases. Each test case contains sumAndAverage integer numbers.
